...
This project is a product of human-AI collaboration. The division of labor is structured as follows:

*   **Human Role:** Conceptualization, architectural design decisions, system verification, security/logic code reviews, and final integration.
*   **AI Role:** Code generation, boilerplate implementation, initial draft writing, and exploring alternative implementation patterns.

All code generated by AI has been human-reviewed, tested, and verified for correctness and safety.
